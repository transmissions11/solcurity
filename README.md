...
**Security checklist for smart contracts written in Solidity.** Based off BoringCrypto's [BentoBox checklist](https://github.com/sushiswap/bentobox/blob/master/documentation/checks.txt).
